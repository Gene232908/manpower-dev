...
export function PartnerModal({
  ...
  useEffect(() => {
    ...
    // Locks the ROOT element, not <body> — the header is `position: sticky`,
    // and locking <body> makes it the nearest scrolling ancestor, which
    // un-sticks the header back to the top of the document. See
    // src/lib/scroll-lock.ts for the bug this avoids.
    lockScroll();
